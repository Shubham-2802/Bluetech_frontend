			...
			<main className="pa4 black-80">
			  <div className="measure center">
			    ...
			    <div className="lh-copy mt3">
			      <p onClick={() => onRouteChange('Adminregister')} className="pointer f6 link dim black db">Want to Register as Admin?</p>
			    </div>
			  </div>
			</main>
		</article>
